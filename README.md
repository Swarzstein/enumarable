...
<div align="center">
  ...
  <h3><b>Juan Zorrilla & Iqbal Elham</b></h3>
...
```sh
  cd my-folder
  git clone https://github.com/swarzstein/enumerable.git
```
...
Feel free to check the [issues page](https://github.com//swarzstein/enumerable/issues).
